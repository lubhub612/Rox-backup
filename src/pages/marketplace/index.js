    ...
    <Layout>
      ...
      <div className="nft-listing-Profile">
        <div className="nft-listing-profile-left">
          ...
          <p>The NFT horse racing game, Zed Run, on Matic network.</p>
          <ul>
            <li>
              <h4>211.2K</h4> <p>items</p>
            </li>
            <li>
              <h4>211.2K</h4> <p>owners</p>
            </li>
            <li>
              <h4>0.005</h4> <p>floor price</p>
            </li>
            <li>
              <h4>1.0K</h4> <p>total volume</p>
            </li>
          </ul>
        </div>
            ...
            {singleLayout && (
              <div className="nft-listing-split-sidebar">
                <Accordion>
                  <AccordionItem>
                    <AccordionItemHeading>
                      <AccordionItemButton>Status</AccordionItemButton>
                    </AccordionItemHeading>
                    <AccordionItemPanel>
                      <ul>
                        <li>
                  ...
                  <AccordionItem>
                    <AccordionItemHeading>
                      <AccordionItemButton>Quantity</AccordionItemButton>
                    </AccordionItemHeading>
                    <AccordionItemPanel>
                      <ul>
                        <li>
                  ...
                  <AccordionItem>
                    <AccordionItemHeading>
                      <AccordionItemButton>Bloodline</AccordionItemButton>
                    </AccordionItemHeading>
                    <AccordionItemPanel>
                      <ul>
                        <li>
