...
const updateProfileInformation = async () => {
    ...
    try {
     ...
     console.log('Updating profile information...');
      ...
      if (r.data.result === 1) {
        ...
        console.log('Cover Image', r.data.msg);
      } else {
     ...
     // hideLoading();
      if (r.data.result === 1) {
       ...
       // toastInfo('Profile Image', r.data.msg);
        console.log('Profile Image', r.data.msg);
      } else {
  ...
  if (name !== '') {
    try {
     ...
     console.log('Updating profile business name...');
      ...
      if (r.data.result === 1) {
       ...
       console.log('Profile Business Name', r.data.msg);
      } else {
        //toastError('Profile Business Name', r.data.msg);
        console.error('Profile Business Name', r.data.msg);
      }
    } catch (err) {
      //hideLoading();
     ...
     // hideLoading();
      if (r.data.result === 1) {
       ...
       // toastInfo('Profile Biography', r.data.msg);
        console.log('Profile Biography', r.data.msg);
      } else {
    ...
    try {
     ...
     // hideLoading();
      if (r.data.result === 1) {
        ...
        console.log('Profile User Name', r.data.msg);
      } else {
    ...
    try {
     ...
     // hideLoading();
      if (r.data.result === 1) {
        ...
        console.log('Profile Email', r.data.msg);
      } else {
              ...
              <div className="profile-setting">
                ...
                />
                  ...
                  <div className="cover-image">
                    <Image src={coverImage} alt="profile_cover"
                    width={330}
                    height={230}
                     />
                    <div className="overlay">
