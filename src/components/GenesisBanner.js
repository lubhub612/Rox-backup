      ...
      <div className="genesis-banner">
        <div className="container">
          <div className="genesis-banner-inner">
            <h2>
              <strong>Dexo</strong> <span>GENESIS</span>
            </h2>
            <h3>First Generation</h3>
            <p>
              Dexo first-generation racehorses are known as the Genesis breed.
              There will only ever be 38,000 Genesis bred racehorses in the Dexo
              ecosystem.
            </p>
          </div>
        </div>
